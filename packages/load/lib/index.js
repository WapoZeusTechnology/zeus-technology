...
export const zeusLoader = ({ url }) =>
  `<scipt crossorigin="true" src="${url}" async="true" id="__zeus_script"></script><script type="application/javascript">document.getElementById("__zeus_script").onload=function(){window.zeus.run()}`;
